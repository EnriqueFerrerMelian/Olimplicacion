...
import com.example.olimplicacion.databinding.ActivityListaEjerciciosBinding;

import java.util.ArrayList;

public class ListaEjerciciosActivity extends AppCompatActivity {
    //ATRIBUTOS
    ActivityListaEjerciciosBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityListaEjerciciosBinding.inflate(getLayoutInflater());
        ...
        listAdapter = new ListAdapter(ListaEjerciciosActivity.this, dataArrayList);
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListaEjerciciosActivity.this, MenuPrincipal.class);
        ...
        binding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ListaEjerciciosActivity.this, DetailedActivity01.class);
